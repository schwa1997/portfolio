    ...
    <ul>
      {blogs.map((blog) => (
        <li key={blog.slug} className="m-10">
          <div className="dark:bg-slate-700 bg-green-100 dark:text-white flex">
            <div className="container grid grid-cols-12 mx-auto dark:bg-slate-700">
              <div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-10">
                ...
                <p className="flex-1 pt-2">{blog.subtitle}</p>
                <Link
                  href={`/blog/${blog.slug}`}
                ...
                <div className="flex items-center justify-between pt-2">
                  <div className="flex space-x-2">
                    ...
                    <span className="self-center text-sm">by myself</span>
                  </div>
