...
export default function NavBar() {
  return (
    <div className="md:place-content-between place-content-center md:m-4 grid grid-rows-2 grid-flow-col gap-2 md:flex pt-4">
      ...
      <div className="md:place-self-center col-span-2 place-self-start space-x-6 shadow-lg bg-gray-600/25 rounded-lg px-6 py-2">
        <Link
          href="/about"
          className="text-base font-normal text-gray-600 dark:text-gray-300"
        >
